      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              "group/sidebar-wrapper min-h-svh w-full has-[[data-variant=inset]]:bg-sidebar block md:flex",
              className
            )}
            ref={ref}
            {...props}
